...
[x] Estimate growth parameters based on Nishiwaki 1963 data
[ ] Simmulation exercise for Bayesian estimation
[ ] Perform exploratory analysis
[ ] Clean and preprocess data
[ ] Fit growth curves to the data
[ ] Calculate posterior
[ ] Wrangle data
[ ] Fit regression
[ ] Plot verification
...
### Scripts
- `Scripts/01_Nishiwaki1963_parameters.R`: Estimates growth parameters from Nishiwaki 1963 data
- `Scripts/02_exploratory_analysis.R`: Initial data exploration and visualization
- `Scripts/03_data_wrangling.R`: Data cleaning and preprocessing
- `Scripts/04_growth_curves.R`: Fits growth curves to the data
- `Scripts/05_posterior_probabilities.R`: Calculates posterior probabilities for sex determination
- `Scripts/06_verification_plots.R`: Creates verification plots
- `Scripts/07_model_diagnostics.R`: Performs model diagnostics and validation
