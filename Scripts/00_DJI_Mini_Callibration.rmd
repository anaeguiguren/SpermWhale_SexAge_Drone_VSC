...
```{r, include = FALSE}
#setwd("C:/Users/balae/Documents/SpermWhale_SexAge_Drone_VSC/")#replace with local repo

#source("Scripts/00_DJI_Mini_Callibration_Data_Prep.R") Original data prep script
dat <- read.csv("Data/Callibration_Data/Callibration_Data_clean.csv", header = T)
library(ggplot2)
library("wacolors")
...
dat<- dat %>% select(Date, FlightNo, imageName, timeStamp, altitudeRaw = altitude, imageWidth = ImageWidth, pixel.length, nadir = nadir) 
